      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-2 text-xl font-bold tracking-tight focus:outline-none
                     focus:ring-2 focus:ring-red-accent/50 rounded-lg px-2 py-1"
          aria-label="Ir al inicio"
        >
          <span className="text-white">TF</span>
          <span className="text-red-accent">Mobility</span>
        </button>
          ...
          {NAV_ITEMS.map((item) => (
            <li key={item.id}>
              <button
                ...
                className="rounded-lg px-4 py-2 text-sm font-medium text-gray transition-colors
                           hover:text-white hover:bg-white/5 focus:outline-none focus:ring-2
        ...
        <button
          ...
          className="md:hidden flex flex-col gap-1.5 p-2 rounded-lg focus:outline-none
                     focus:ring-2 focus:ring-red-accent/50"
              ...
              <li key={item.id}>
                <button
                  ...
                  className="w-full text-left rounded-lg px-4 py-3 text-sm font-medium
                             text-gray transition-colors hover:text-white hover:bg-white/5"
                >
                  {item.label}
                </button>
              </li>
